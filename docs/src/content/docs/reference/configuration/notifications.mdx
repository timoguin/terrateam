...
The `notifications` configuration can be used to set different comment update strategies for different directories and workspaces, and to enable the summary header on plan and apply comments.
