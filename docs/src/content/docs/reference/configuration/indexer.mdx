...
| build_tag | String | The container image the runner pulls to execute the indexer. Default is `ghcr.io/terrateamio/terrat-code-indexer:latest`. Set it to pin a version or to use a mirror. |
