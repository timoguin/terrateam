module Primary = struct
  module Action = struct
    let t_of_yojson = function
      | `String "updated_assignment" -> Ok `Updated_assignment
      | json -> Error ("Unknown value: " ^ Yojson.Safe.pretty_to_string json)

    let t_to_yojson = function
      | `Updated_assignment -> `String "updated_assignment"

    type t = ([ `Updated_assignment ][@of_yojson t_of_yojson] [@to_yojson t_to_yojson])
