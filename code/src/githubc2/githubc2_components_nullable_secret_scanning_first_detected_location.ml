type t =
  ...
  | Secret_scanning_location_issue_body of Githubc2_components_secret_scanning_location_issue_body.t
     ...
     [
       ...
       (fun v ->
         map
           ...
           (Githubc2_components_secret_scanning_location_pull_request_review_comment.of_yojson v));
     ])
