module Remove = struct
  ...
  let url = "/enterprises/{enterprise}/teams/{enterprise-team}/memberships/{username}"
...
module Add = struct
  ...
  module Responses = struct
    module Created = struct
      type t = Githubc2_components.Simple_user.t
      [@@deriving yojson { strict = false; meta = false }, show, eq]
    end
...
module Bulk_remove = struct
  ...
  module Request_body = struct
    module Primary = struct
      module Usernames = struct
        type t = string list [@@deriving yojson { strict = false; meta = true }, show, eq]
      end

      type t = { usernames : Usernames.t }
  ...
  let url = "/enterprises/{enterprise}/teams/{enterprise-team}/memberships/remove"
...
module Bulk_add = struct
  ...
  let url = "/enterprises/{enterprise}/teams/{enterprise-team}/memberships/add"
...
module List = struct
  ...
  let url = "/enterprises/{enterprise}/teams/{enterprise-team}/memberships"
